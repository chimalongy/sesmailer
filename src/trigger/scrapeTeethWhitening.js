...
export async function runScrape(location = "San Diego", niche = "teeth whitening clinics") {
    const apiKey = "fc-12e9aa9a21f8473e93b860c1fcbd3bb1";
    if (!apiKey) {
    ...
    const response = await app.agent({
        prompt: `Find local ${niche} and dentists providing these services in ${location}. Extract their business names and direct website URLs.`,
